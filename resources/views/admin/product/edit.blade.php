...
@endphp 
  ...
  <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="forms-sample">
    ...
    <div class="col-lg-12 grid-margin stretch-card px-5">
              ...
              <div class="col-sm-9">
                <input type="text" name="title" class="form-control" value="{{$product->title}}" id="titleInput" placeholder="Name">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="input-group">
                  ...
                  <input type="text" name="regular_price" value="{{$product->regular_price}}" class="form-control" id="regular_priceInput" placeholder="Regular Price" aria-label="Regular Price" aria-describedby="basic-addon1">
                </div>
                @error('regular_price') <span> {{$message}} </span> @enderror
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="input-group">
                  ...
                  <input type="text" name="sale_price" value="{{$product->sale_price}}" class="form-control" id="sale_priceInput" placeholder="Sale Price" aria-label="Sale Price" aria-describedby="basic-addon1">
                </div>
                @error('sale_price') <span> {{$message}} </span> @enderror
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="input-group">
                  ...
                  <input type="text" name="points" value="{{$product->points}}" class="form-control" id="sale_priceInput" placeholder="Sale Price" aria-label="Sale Price" aria-describedby="basic-addon1">
                </div>
                @error('points') <span> {{$message}} </span> @enderror
              </div>
            </div>
              ...
              <div class="col-sm-9">
                  <div class="form-group">
                    <div class="form-check">
                        ...
                        <input type="checkbox" id="prod_featured" name="prod_featured" @if($product->prod_featured == '1'){{ 'checked'}} @endif value="1" class="form-check-input">Featured Product</label>
                    </div>
                  </div>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                  <div class="form-group">
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" id="prod_new_arrival" name="prod_new_arrival" @if($product->prod_new_arrival == '1'){{ 'checked'}} @endif value="1" class="form-check-input">New Arrival</label>
                    </div>
                  </div>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                @php 
                if($product->image != ''){
                  echo '<img src="'. asset('public'.$product->image) .'" alt="'. $product->title .'" class="mb-2 mw-100 w-100 rounded">'; 
                }
                @endphp
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="file" name="new_images[]" multiple id="photo-upload" class="file-upload-default">
                <div class="input-group col-xs-12">
                  <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image">
                  <span class="input-group-append">
                    <button class="file-upload-browse btn btn-gradient-primary py-3" type="button">Upload Images</button>
                  </span>
                </div>
              </div>
              <div class="col-sm-3">                
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9"> <div id="photo-upload__preview" class="upload-preview">
                @if(count($product_images) > 0 )
                    @foreach($product_images as $product_image)
                    <div class="item-image"><img src="{{ asset('public'.$product_image) }}" class="item-photo__preview">
                    <input type="hidden" name="old_images[]" value="{{ $product_image}}" />
                    <button type="button" class="btn-delete delete_image btn btn-primary btn-sm"><span>×</span></button></div>
                    @endforeach
                @endif
              </div>
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9 section_scroll">
                  <div class="form-group">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" name="prod_cats[]" @if(in_array($category->id, $product_cat_selected)){{ 'checked'}} @endif value="{{ $category->id}}" class="form-check-input">{{$category->title}}</label>
                    </div>
                    @if(count($category->subcategory))
                        @include('admin.components.subcatcheckbox',['subcategories' => $category->subcategory, 'product_cat_selected' => $product_cat_selected ])
                    @endif
                    @endforeach
                  @endif
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9 section_scroll">
                  <div class="form-group">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" name="prod_sizes[]" @if(in_array($productsize->id, $product_size_selected)){{ 'checked'}} @endif value="{{ $productsize->id}}" class="form-check-input">{{$productsize->title}}</label>
                    </div>
                    @endforeach
                  @endif
                  </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9 section_scroll">
                  <div class="form-group">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                        <input type="checkbox" name="prod_colors[]" @if(in_array($productcolor->id, $product_color_selected)){{ 'checked'}} @endif value="{{ $productcolor->id}}" class="form-check-input">{{$productcolor->title}}</label>
                    </div>
                    @endforeach
                  @endif
                  </div>
            ...
            <div class="form-group row">
              ...
              <select class="form-select" name="stock_status" id="stock_statusInput">
                ...
                @error('stock_status') <span> {{$message}} </span> @enderror
              </div>
            </div>
              ...
              <select class="form-select" name="status" id="statusInput">
                ...
                @error('status') <span> {{$message}} </span> @enderror
                  ...
                  <button type="submit" class="btn btn-info sfw">{{$addEdit}}</button>
                      <a href="{{route('product.index')}}" class="btn btn-info sfw" ><i class="fa fa-mail-reply"></i> Cancel </a>
      </form>
