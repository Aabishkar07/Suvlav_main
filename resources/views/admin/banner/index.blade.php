                ...
                <div class="row margin-bottom-30">
                    <form method="get" class="forms-sample deceased-search">
                        ...
                        <div class="form-group row">
                            ...
                            @can('View Banner')
                                <div class="mt-2 col-sm-6"> <a href="{{ route('banner.create') }}"
                    ...
                    <tbody>
                        ...
                        @if (count($banners) > 0)
                            @foreach ($banners as $key => $banner)
                                ...
                                @php
                                    $banner_image_url =
                                        $banner->image != '' ? 'public' . $banner->image : 'assets/images/no_photo.jpg';
                                @endphp
                                <tr>
                                    ...
                                    @can('Edit Banner')
                                        <td><a href="{{ route('banner.edit', $banner->id) }}" class="btn btn-success btn-sm"><i
