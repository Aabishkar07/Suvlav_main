            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="site_name" value="{{ $site_settings['site_name'] }}"
                                class="form-control" id="site_nameInput" placeholder="Site Name">
                            @error('site_name')
                                <span> {{ $message }} </span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="site_email" value="{{ $site_settings['site_email'] }}"
                                class="form-control" id="site_emailInput" placeholder="Site Email">
                            @error('site_email')
                                <span> {{ $message }} </span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="site_phone" value="{{ $site_settings['site_phone'] }}"
                                class="form-control" id="site_phoneInput" placeholder="Site Email">
                            @error('site_phone')
                                <span> {{ $message }} </span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="posts_per_page" value="{{ $site_settings['posts_per_page'] }}"
                                class="form-control" id="posts_per_pageInput" placeholder="Posts per page">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="site_currency" value="{{ $site_settings['site_currency'] }}"
                                class="form-control" id="site_currencyInput" placeholder="Posts per page">
                            @error('site_currency')
                                <span> {{ $message }} </span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="address" value="{{ $site_settings['address'] ?? '' }}"
                                class="form-control" id="addressInput" placeholder="Enter your address">
                            @error('address')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="referral_points"
                                value="{{ $site_settings['referral_points'] ?? '' }}" class="form-control"
                                id="addressInput" placeholder="Enter your address">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="web_point"
                                value="{{ $site_settings['web_point'] ?? '' }}" class="form-control"
                                id="addressInput" placeholder="Enter point">
                            @error('web_point')
                                <span class="text-danger"> {{ $message }} </span>
                            @enderror
                        </div>
                            ...
                            <div class="form-group row w-100">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="facebook_link"
                                        value="{{ $site_settings['facebook_link'] ?? '' }}" class="form-control"
                                        id="facebookLinkInput" placeholder="Enter Facebook link">
                                    @error('facebook_link')
                                        <span class="text-danger"> {{ $message }} </span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row w-100">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="instagram_link"
                                        value="{{ $site_settings['instagram_link'] ?? '' }}" class="form-control"
                                        id="instagramLinkInput" placeholder="Enter Instagram link">
                            ...
                            <div class="form-group row w-100">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="youtube_link"
                                        value="{{ $site_settings['youtube_link'] ?? '' }}" class="form-control"
                                        id="youtubeLinkInput" placeholder="Enter YouTube link">
                                    @error('youtube_link')
                                        <span class="text-danger"> {{ $message }} </span>
                                    @enderror
                                </div>
