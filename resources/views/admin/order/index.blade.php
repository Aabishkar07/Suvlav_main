    ...
    <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="row margin-bottom-30">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="text" name= "tracking_code" class="form-control" id="searchName" value="{{ $request->tracking_code }}" placeholder="Search by OrderId..">
                            </div>
                            <div class="col-sm-3">
                          <button class="btn btn-info sfw btn-sm btn_search" type="submit"><i class="fa fa-search"></i> Search</button>
                          <a href="{{route('order.index')}}" class="btn btn-info sfw btn-sm" ><i class="fa fa-mail-reply"></i> Reset </a>
                        </div>
                      </div>
              ...
              <td><a href="<?php echo url('admin/order/showdetails/'.$order->id); ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> </a>
              <a href="{{ route('order.edit', $order->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
              </td>
