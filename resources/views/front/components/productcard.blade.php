...
<div class="rounded shadow single-product border ">

    <div class="d-flex justify-between p-1 bg-white">
        <a class="" href="{{ url('product/' . $list->slug) }}">{{ $list->title }}</a>
        @php
    ...
    <div class="px-3 py-2 product-content">
        ...
        <div class="items-center justify-between d-flex">
            ...
            <div class="product-price px-2 py-1 text-xs text-white rounded discount-badge bg-success">
