							...
							@csrf
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-12">
											<div class="form-group">
												<label>Password<span>*</span></label>
												<input type="password" name="password" placeholder="" required="required" minlength="6">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-12">
											<div class="form-group">
							...
							@csrf
								<div class="row">
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Full Name<span>*</span></label>
											<input type="text" name="name" value="{{ @$shippings[0]->fullname }}" required="required">
											<input type="hidden" readonly name="email" value="{{ Session::get('memeber_email_ss'); }}" required="required">
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Mobile No.<span>*</span></label>
											<input type="number" name="mobileno" placeholder="" value="{{ @$shippings[0]->mobile }}" maxlength="10" required="required">
										</div>
									</div>
									<?php
										// echo '<pre>';
										...
										<div class="form-group">
											...
											<select id="province_data" class="form-control district" name="province_id" required onchange="getDistrictsByState('<?php echo url('getdistricts'); ?>')">
												...
												<?php foreach($states_del as $dd){ ?>
													<option value="<?php echo $dd->id; ?>" <?php if($dd->id == @$shippings[0]->province){ echo 'selected';} ?>> <?php echo  $dd->name; ?> </option>
													<?php } ?>
											</select>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<select class="form-control" name="district" id="district_id" required>
											 ...
											 foreach($districts as $dt): ?>
												<option value="<?php echo $dt->id; ?>" <?php if($dt->id == @$shippings[0]->district_id){ echo 'selected'; }?> > <?php echo $dt->district; ?> </option>
											<?php endforeach;
											      endif;
											?>
											</select>
									...
									<div class="col-lg-6 col-md-6 col-12">
											<div class="form-group">
											<label>City<span>*</span></label> &nbsp; <input type="text" name="city_del" value="{{ @$shippings[0]->city }}" required="required">
											</div>
										</div>
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Address<span>*</span></label>
											<input type="text" name="address" placeholder="" value="{{ @$shippings[0]->address }}" required="required">
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
										<span>Gaupalika</span> &nbsp;<input type="text" name="gaupalika" value="{{ @$shippings[0]->gaupalika }}">
										</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-12">
									<div class="form-group">
									<span>Nagarpalika</span> &nbsp;<input type="text" name="nagarpalika" value="{{ @$shippings[0]->nagarpalika }}">
									</div>
							</div>

							<div class="col-lg-6 col-md-6 col-12">
								<div class="form-group">
								<span>Ward no</span> &nbsp;<input type="text" name="wardno" value="{{ @$shippings[0]->wardno }}">
								</div>
						</div>
									...
									<div class="shopping-item" style="padding-left: 25px;">
										...
										@foreach($cartItems as $cartItem)
											<li>
												...
												<a class="cart-img" href="javascript:void(0);"><img src="{{ asset('public/'. $cartItem->product_image) }}" width="50px"></a>
